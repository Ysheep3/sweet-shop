 ...
 */
@Component
public class CouponDelayExecuteEndProducer extends AbstractCommonSendProduceTemplate<CouponExecuteStatusEvent> {
    private final ConfigurableEnvironment configurableEnvironment;

    public CouponDelayExecuteEndProducer(
    ...
    protected BaseSendExtendDTO buildSendExtendDTO(CouponExecuteStatusEvent messageSendEvent) {
        return BaseSendExtendDTO.builder()
                ...
                .topic(configurableEnvironment.resolvePlaceholders("sweet-shop-coupon-admin-service_coupon-delay_end_topic"))
